...
static struct key keys_full[] = {
  ...
  {"-", "-", 0.5, Code, KEY_MINUS},
  {"=", "=", 0.5, Code, KEY_EQUAL},
  {"^", "^", 0.5, Copy, 0x005E, .scheme = 0},
  {"°", "°", 0.5, Copy, 0x00B0, .scheme = 0},
  ...
  {"\"", "\"", 0.5, Copy, 0x0022, (struct layout *)0, 0x0022},
  {"q", "Q", 1.0, Code, KEY_Q},
  ...
  {"[", "[", 0.3, Code, KEY_LEFTBRACE},
  {"]", "]", 0.3, Code, KEY_RIGHTBRACE},  
  {"{", "{", 0.3, Copy, 0x007b, (struct layout *)0, 0x007b},
  ...
  {"?", "?", 0.5, Copy, 0x003f, (struct layout *)0, 0x003f},
  {"!", "!", 0.5, Copy, 0x0021, (struct layout *)0, 0x0021},
  {",", ",", 0.5, Code, KEY_COMMA},
  {".", ".", 0.5, Code, KEY_DOT},
  {"/", "/", 0.5, Code, KEY_SLASH},
  {"_", "_", 0.5, Copy, 0x005f, (struct layout *)0, 0x005f},    
  {"@", "@", 0.5, Copy, 0x0040, (struct layout *)0, 0x0040},
  ...
  {"Ctr", "Ctr", 1.0, Mod, Ctrl, .scheme = 1},
  {"📻", "📻", 0.5, Code, KEY_WWW, .scheme = 1},
  {"⏮️", "⏮️", 0.5, Code, KEY_PREVIOUSSONG, .scheme = 1},
  {"⏯️", "⏯️", 0.5, Code, KEY_PLAYPAUSE, .scheme = 1},
  {"⏭️", "⏭️", 0.5, Code, KEY_NEXTSONG, .scheme = 1},
  {"🤫", "🤫", 0.5, Code, KEY_MUTE, .scheme = 1},
  {"🔉", "🔉", 0.5, Code, KEY_VOLUMEDOWN, .scheme = 1},  
  {"🔊", "🔊", 0.5, Code, KEY_VOLUMEUP, .scheme = 1},    
  {"~", "~", 0.5, Copy, 0x007e, (struct layout *)0, 0x007e},
  {"*", "*", 0.5, Copy, 0x002a, (struct layout *)0, 0x002a},
  {"(", "(", 0.5, Copy, 0x0028, (struct layout *)0, 0x0028},
  {")", ")", 0.5, Copy, 0x0029, (struct layout *)0, 0x0029},  
  {"⇤", "⇤", 0.5, Code, KEY_HOME},
  {"⇥", "⇥", 0.5, Code, KEY_END},
  {"⩓", "⩓", 0.5, Code, KEY_PAGEUP},
  {"⩔", "⩔", 0.5, Code, KEY_PAGEDOWN},  
